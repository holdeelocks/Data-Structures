class Heap:
    ...
    def _bubble_up(self, index):
        ...
        if index > 0 and self.compare(curr_val, parent_val):
    ...
    def _sift_down(self, index):
        ...
        if right_child_idx is not None and self.compare(right_child_val, left_child_val):
            best_child_idx, best_child_val = right_child_idx, right_child_val

        if best_child_idx is not None and self.compare(best_child_val, curr_val):
